...
//	    attributes:被添加到节点的自定义属性。
		...
		public List<StuMenu> getChildren() {
			return children;
		}

		public void setChildren(List<StuMenu> children) {
		...
		public String toString() {
			return "StuMenu [id=" + id + ", name=" + name + ", pid=" + pid + ", children=" + children + ", filename="
